...
“啥”被定义为“读印”，它会将变数的值显示出来；“增”用来对变数的值进行增一，“减”则用来对变数的值进行减一；“倍”用来对变数的值进行加倍，“衰”则用来对变数的值进行减倍。
...
<div class="editor-preview editor-text">变通<span class="output">  完成！</span>
123通写 <span class="output"> 完成！</span>
通啥 <span class="output">123  完成！</span>
50通增 <span class="output"> 完成！</span>
通啥 <span class="output">173  完成！</span>
</div>
